...
export default function TeacherChatScreen({ navigation, route }) {
  const app = useApp();
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <AppHeader title="Chat" navigation={navigation} />

      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>Parent Communication</Text>
          <Text style={styles.heroSub}>Send and receive messages from parents.</Text>
        </View>
        ...
        {app.messages.map((m) => (
          <TCard
            ...
            subtitle={m.message}
            status={m.read ? "READ" : "MESSAGE"}
            icon="chatbubble-outline"
          />
        ))}

        <View style={styles.form}>
          <AppInput label="Reply Message" value={message} onChangeText={setMessage} />
