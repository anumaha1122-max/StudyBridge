...
export default function StudentListScreen({ navigation, route }) {
  ...
  const students = app.students.filter((s) => s.classId === classId);
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>Class Students</Text>
          <Text style={styles.heroSub}>Open a student to view performance, attendance, and records.</Text>
        </View>
        ...
        {students.map((student) => (
          <TCard
            ...
            status={(student.performancePercentage || 0) + "%"}
            icon="person-outline"
          />
        ))}
      </ScrollView>
