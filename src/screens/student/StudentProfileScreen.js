...
export default function StudentProfileScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <AppHeader title="Student Profile" navigation={navigation} />

      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>{student?.name || currentUser?.name}</Text>
          <Text style={styles.heroSub}>{currentUser?.email || "student@studybridge.com"}</Text>
        </View>
        ...
        <SCard
          ...
          subtitle={student?.emergencyContact || "Not added"}
          status="CONTACT"
          icon="call-outline"
        />
