...
export default function HomeworkDetailsScreen({ navigation, route }) {
  ...
  const submission = app.homeworkSubmissions.find(
  ...
  if (!homework) {
    return (
      <SafeAreaView style={styles.safe}>
        <AppHeader title="Homework Details" navigation={navigation} />
        <ScrollView contentContainerStyle={styles.content}>
          <SCard title="Homework not found" subtitle="Please go back and select homework again." />
        </ScrollView>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>{homework.title}</Text>
          <Text style={styles.heroSub}>{homework.subject} • Due: {homework.dueDate}</Text>
        </View>

        <SCard
          title="Teacher"
          subtitle={homework.teacherName + " • " + homework.className}
          status="ASSIGNED"
          icon="person-outline"
        />

        <SCard title="Description" subtitle={homework.description || "No description"} icon="document-text-outline" />
        <SCard title="Instructions" subtitle={homework.instructions || "No instructions"} icon="information-circle-outline" />
        ...
        {submission ? (
          <SCard
            ...
            subtitle={
              ...
              (submission.teacherRemark ? " • Remark: " + submission.teacherRemark : "")
            }
