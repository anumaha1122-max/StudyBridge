...
export default function AskDoubtScreen({ navigation, route }) {
  const app = useApp();
  ...
  const submit = () => {
    if (!form.doubtText) {
      setSuccess("Please enter your doubt.");
      return;
    }
    ...
    setForm({ ...form, doubtText: "", attachmentName: "" });
    setSuccess("Doubt submitted. Teacher notified.");
  };

  return (
    <SafeAreaView style={styles.safe}>
      <AppHeader title="Ask Doubt" navigation={navigation} />

      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>Ask a Doubt</Text>
          <Text style={styles.heroSub}>Teacher can answer your doubt from teacher panel.</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <AppInput
            ...
            onChangeText={(v) => setForm({ ...form, doubtText: v })}
            multiline
          ...
          <AppInput
            ...
            placeholder="optional-photo.jpg"
          />

          <AppButton title="Submit Doubt" onPress={submit} />
        </View>

        <AppButton title="View Discussion" variant="outline" onPress={() => navigation.navigate("DoubtDiscussion")} />
