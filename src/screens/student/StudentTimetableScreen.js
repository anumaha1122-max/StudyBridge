...
export default function StudentTimetableScreen({ navigation, route }) {
  const app = useApp();
  ...
  const periods = app.timetable.filter((t) => t.classId === student?.classId || t.classId === 1);

  return (
    <SafeAreaView style={styles.safe}>
      <AppHeader title="Timetable" navigation={navigation} />
