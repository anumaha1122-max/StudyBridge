    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          ...
          <Text style={styles.heroSub}>Homework, marks, attendance, notes and doubts updates.</Text>
        </View>

        {notifications.length === 0 ? (
          <SCard title="No notifications" subtitle="Updates will appear here." icon="notifications-outline" />
        ) : (
          notifications.map((n) => (
            <SCard
              key={n.id}
